...
export class CanDeactivateUpdateGuard implements CanDeactivate<ItemUpdateComponent> {
  ...
  canDeactivate(component: ItemUpdateComponent, route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<boolean> | boolean {
